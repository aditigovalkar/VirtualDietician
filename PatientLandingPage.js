...
function PatientLandingPage(props) {
            ...
            <GridItem xs={12} sm={12} md={4}>
              ...
              >
                <CardHeader color="warning" className={classes.cardHeader}>
                  <h4>Hello </h4> <h2>{props.location.state.detail.name}</h2>
                </CardHeader>
                <CardBody>
                  <p> Let's know you more with new informations</p>
                </CardBody>
...
export default withRouter(PatientLandingPage);
